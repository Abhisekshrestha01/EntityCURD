<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="entitypractise1.WebForm1" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DataObjectTypeName="entitypractise1.Employee" DeleteMethod="DeleteEmployee" InsertMethod="InsertEmployee" SelectMethod="GetEmployees" TypeName="entitypractise1.EmployeeRepository" UpdateMethod="UpdateEmployee"></asp:ObjectDataSource>
    </form>
</body>
</html>
